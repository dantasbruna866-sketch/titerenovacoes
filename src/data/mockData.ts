...
export const mockClients: Client[] = [
  {
    ...
    interactions: [
      ...
      { id: 'i2', date: '2025-04-09 14:00', type: 'whatsapp', message: 'Olá Roberto, segue o link para renovação.', dispatchStatus: 'lido' },
  ...
  },
  {
    ...
    vendedor: 'Carlos Souza', tags: ['Aguardando retorno'],
  ...
  },
  {
    ...
    vendedor: null, tags: ['Sem resposta', 'Caixa postal'],
    observacao: 'Tentativas de contato sem sucesso.',
    interactions: [
      ...
      { id: 'i9', date: '2025-04-05 09:30', type: 'whatsapp', message: 'Precisamos falar sobre seu certificado.', dispatchStatus: 'entregue' },
    ],
    blacklist: false,
  },
  {
    ...
    vendedor: 'Maria Oliveira', tags: ['Cliente quente', 'Primeiro contato'],
  ...
  },
  {
    ...
    vendedor: 'Paula Lima', tags: ['Sem resposta'],
  ...
  },
  {
    ...
    interactions: [
      { id: 'i16', date: '2025-04-13 10:00', type: 'ligacao', callStatus: 'atendeu', notes: 'Interessado, pediu mais info' },
    ],
    blacklist: false,
  },
  {
